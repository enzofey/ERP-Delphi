object FatGeralForm: TFatGeralForm
  ...
  object Panel1: TPanel
    ...
    object RBDadosAdicionais: TRadioGroup
      Left = 24
      Top = 250
      Width = 346
      Height = 143
    ...
    object Totais: TGroupBox
      ...
      object lblValor_base_icms: TLabel
        Left = 16
        Top = 61
        Width = 58
        Height = 15
      ...
      object lblValor_Base_IPI: TLabel
        Left = 16
        Top = 134
        Width = 43
        Height = 15
      ...
      object lblValor_Base_PIS_COFINS: TLabel
        Left = 206
        Top = 24
        Width = 92
        Height = 15
      ...
      object lblValor_Produtos: TLabel
        Left = 217
        Top = 134
        Width = 80
        Height = 15
      ...
      object lblValorNTotal: TLabel
        Left = 448
        Top = 172
        Width = 82
        Height = 15
        Caption = 'Valor N'#227'o Total:'
      end
      object lvlValor_Seguro: TLabel
        Left = 448
        Top = 134
        Width = 69
        Height = 15
      ...
      object EdtValor_Base_ICMS: TEdit
        Left = 79
        Top = 58
        Width = 121
        Height = 23
      ...
      object edtValor_Base_IPI: TEdit
        Left = 79
        Top = 131
        Width = 121
        Height = 23
      ...
      object EdtValor_base_PIS_COFINS: TEdit
        Left = 303
        Top = 21
        Width = 128
        Height = 23
      ...
      object EdtValor_Produtos: TEdit
        Left = 303
        Top = 131
        Width = 128
        Height = 23
    ...
    object EdtEspecie: TEdit
      ...
      Enabled = False
      TabOrder = 17
      OnExit = EdtValFreteChange
    end
    object EdtPesoL: TEdit
      Left = 678
      Top = 61
      Width = 107
      Height = 23
    ...
    object Duplicatas: TGroupBox
      ...
      object EdtMoedaDescricao: TEdit
        Left = 83
        Top = 53
        Width = 110
        Height = 23
