object CadEntidade: TCadEntidade
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'CadEntidade'
  ...
  object Pages: TPageControl
    ...
    object AcessoPage: TTabSheet
      ...
      object SBConsEntidade: TSpeedButton
        Left = 271
        Top = 45
        Width = 23
        Height = 23
        OnClick = SBConsEntidadeClick
      end
      object lblAcessoIndIE: TLabel
        Left = 301
        Top = 106
        Width = 35
        Height = 15
      ...
      object SBAcessoClearIndIE: TSpeedButton
        ...
        Width = 23
        Height = 23
        OnClick = SBAcessoClearIndIEClick
      end
      ...
      object AcessoGrid: TDBGrid
        ...
        Width = 1769
        Height = 729
        DataSource = CadEntidadeDM.dsAcesso
        TabOrder = 5
      ...
      object CBAcessoIndIE: TComboBox
        Left = 349
        Top = 103
        Width = 156
        Height = 23
        ...
        TabOrder = 6
        OnDropDown = CBAcessoIndIEDropDown
        Items.Strings = (
      ...
      object EdtAcessoCodigoCEP: TEdit
        Left = 328
        Top = 74
        Width = 41
        Height = 23
        TabOrder = 11
        OnChange = EdtAcessoCodigoCEPChange
      end
      ...
      object RGAcessoConsumidor_Final: TRadioGroup
        Left = 300
        Top = 3
        Width = 234
        Height = 36
    ...
    object CadastroPage: TTabSheet
      ...
      object lblConsumidorFinal: TLabel
        Left = 476
        Top = 48
        Width = 97
        Height = 15
