...
begin
 ...
 begin
  ...
  SQL.Clear;
  SQL.Add('update receber set status = :status where fatura = :fatura and emp_id = :emp_id and entidade = :entidade');
  ParamByName('status').AsString := 'CANC';
  ParamByName('fatura').AsString := ImpressaoNFEDM.qryGridNota.FieldByName('fatura').AsString;
  ParamByName('emp_id').AsString := ImpressaoNFEDM.qryGridNota.FieldByName('emp_id').AsString;
  ParamByName('entidade').AsString := ImpressaoNFEDM.qryGridNota.FieldByName('codcli').AsString;
  ExecSQL;
 end;
 ...
 begin
  SQL.Clear;
  SQL.Add('select mov_est, tipo from cadnatureza where natureza = :natureza');
  ParamByName('natureza').AsString := ImpressaoNFEDM.qryGridNota.FieldByName('natureza').AsString;
  Open;

  if FieldByName('Mov_Est').AsString = 'S' then begin
   if FieldByName('Tipo').AsString = 'E' then begin
   ImpressaoNFEDM.qryNotaIten.First;
   while not ImpressaoNFEDM.qryNotaIten.Eof do
    with ImpressaoNFEDM.qrySelectEstoque do begin
     SQL.Clear;
     SQL.Add('select qtde from estoque');
     SQL.Add('where codigo = :codigo and cor = :cor and tamanho = :tamanho and lote = :lote and deposito = :deposito');
     ParamByName('codigo').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('codigo').AsString;
     ParamByName('cor').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('cor').AsString;
     ParamByName('tamanho').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('tamanho').AsString;
     ParamByName('lote').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('lote').AsString;
     ParamByName('deposito').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('deposito').AsString;
     Open;

     if not IsEmpty then begin
      with ImpressaoNFEDM.qryUpdateEstoque do
      begin
       SQL.Clear;
       ...
       ParamByName('lote').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('lote').AsString;
       ParamByName('deposito').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('deposito').AsString;
       ParamByName('qtde').AsString := ImpressaoNFEDM.qryNotaIten.FieldByName('qtde').AsString;
       ExecSQL;
      end;

      with ImpressaoNFEDM.qryInsertProdMov do
      begin
       SQL.Clear;
       ...
       'Movimentação realizada a partir do cancelamento da nota: ' + ImpressaoNFEDM.qryGridNota.FieldByName('fatura').AsString;
       ExecSQL;
      end;
     end;
    end;
   ...
   if FieldByName('Tipo').AsString = 'S' then begin
   ImpressaoNFEDM.qryNotaIten.First;
   while not ImpressaoNFEDM.qryNotaIten.Eof do
    with ImpressaoNFEDM.qrySelectEstoque do begin
     SQL.Clear;
     ...
     if not IsEmpty then begin
      ...
      begin
       ...
       ParamByName('usuario').AsString := UsuarioLogado;
       ParamByName('obs').AsString := 'Movimentação realizada a partir do cancelamento da nota: ' + ImpressaoNFEDM.qryGridNota.FieldByName('fatura').AsString;
       ExecSQL;
      end;
     end;
    end;
...
begin
 ...
 begin
  ...
  SQL.Add('CSOSN, ');
  SQL.Add('val_icms, ');
  SQL.Add('val_base_icms, ');
  SQL.Add('aliq_icms, ');
  SQL.Add('CST_IPI, ');
  SQL.Add('ENQ_IPI, ');
  SQL.Add('aliq_ipi, ');
  SQL.Add('val_ipi, ');
  SQL.Add('val_base_ipi ');
  SQL.Add('val_base_pis_cofins, ');
  SQL.Add('CST_PIS, ');
  SQL.Add('ALIQ_PIS, ');
  SQL.Add('val_pis, ');
  SQL.Add('CST_COFINS, ');
 ...
 begin
  ...
  SQL.Add('tipo, ');
  SQL.Add('natureza, ');
  SQL.Add('Aliq_Cred_Pres, ');
  SQL.Add('Realiza_Calc_CredPres ');
  SQL.Add('from cadnatureza ');
 ...
 begin
  SQL.Clear;
  SQL.Add('select consumidor_final, ');
  SQL.Add('ent.CPF, ');
  SQL.Add('ent.Nome, ');
  SQL.Add('ent.rua, ');
  SQL.Add('ent.numero, ');
  SQL.Add('ent.complemento, ');
  SQL.Add('ent.Bairro, ');
  SQL.Add('ent.Estado, ');
  SQL.Add('ent.CEP, ');
  ...
  SQL.Add('ent.IE, ');
  SQL.Add('ent.IndIE, ');
  SQL.Add('pais.codigo_ibge as pais_ibge, ');
  SQL.Add('pais.pais as pais_nome, ');
  SQL.Add('cid.codigo_ibge as cidade_ibge, ');
  SQL.Add('estado.codigo as estado_ibge ');
  SQL.Add('from cadentidade ent ');
  SQL.Add('inner join cadpais pais on (pais.sigla = ent.pais) ');
  SQL.Add('inner join cadcidade cid on (cid.cidade = ent.cidade) ');
  SQL.Add('inner join cadestado estado on (estado.sigla = ent.estado) ');
  SQL.Add('where ent.codigo = :codcli');
 ...
 begin
  SQL.Clear;
  SQL.Add('select pais.codigo_ibge as pais_ibge, ');
  SQL.Add('pais.pais as pais_nome, ');
  SQL.Add('cid.codigo_ibge as cidade_ibge, ');
  SQL.Add('estado.codigo as estado_ibge, ');
  SQL.Add('emp.CNPJ, ');
  ...
  SQL.Add('emp.IE, ');
  SQL.Add('emp.CRT, ');
  SQL.Add('emp.Fantasia, ');
  SQL.Add('emp.telefone ');
  SQL.Add('from empresa emp ');
  SQL.Add('inner join cadpais pais on (pais.sigla = emp.pais) ');
  SQL.Add('inner join cadcidade cid on (cid.cidade = emp.cidade) ');
  SQL.Add('inner join cadestado estado on (estado.sigla = emp.estado) ');
  SQL.Add('where emp.emp_id = :emp_id');
  ParamByName('emp_id').AsString := EmpresaLogada;
  Open;
 end;
 ...
 try
  ...
  if CBModo.Text = 'Emissão normal' then idenode.AddChild('tpEmis').Text := '1'
  else if CBModo.Text = 'Contingência FS-IA' then idenode.AddChild('tpEmis').Text := '2'
  else if CBModo.Text = 'Contingência SCAN' then idenode.AddChild('tpEmis').Text := '3'
  else if CBModo.Text = 'Contingência EPEC' then idenode.AddChild('tpEmis').Text := '4'
  else if CBModo.Text = 'Contingência FS-DA' then idenode.AddChild('tpEmis').Text := '5'
  else if CBModo.Text = 'Contingência SVC-AN' then idenode.AddChild('tpEmis').Text := '6'
  else if CBModo.Text = 'Contingência SVC-RS' then idenode.AddChild('tpEmis').Text := '7';
