...
type
  ...
  private
    ...
    NatRealiza_calc_credpres: string;
    NatMov_Est: string;
    NatGera_Dupl: string;
  public
   ...
   function Realiza_calc_credpres: string;
   function Mov_est: string;
   function Gera_dupl: string;
  end;
...
begin
 ...
 begin
  NatNatureza := FieldByName('natureza').AsString;
  NatDescricao := FieldByName('descricao').AsString;
  NatAtivo := FieldByName('ativo').AsString;
  NatTipo := FieldByName('tipo').AsString;
  NatCST_ICMS := FieldByName('CST_ICMS').AsString;
  NatCSOSN := FieldByName('CSOSN').AsString;
  NatCST_IPI := FieldByName('CST_IPI').AsString;
  NatENQ_IPI := FieldByName('ENQ_IPI').AsString;
  NatCST_PIS := FieldByName('CST_PIS').AsString;
  NatCST_COFINS := FieldByName('CST_COFINS').AsString;
  NatcBenef := FieldByName('cBenef').AsString;
  NatcCredPres := FieldByName('cCredPres').AsString;
  NatAliq_icms := FieldByName('aliq_icms').AsString;
  Nataliq_ipi := FieldByName('aliq_ipi').AsString;
  Nataliq_pis := FieldByName('aliq_pis').AsString;
  Nataliq_cofins := FieldByName('aliq_cofins').AsString;
  NatAliq_Cred_Pres := FieldByName('Aliq_Cred_Pres').AsString;
  NatRealiza_calc_credpres := FieldByName('Realiza_calc_credpres').AsString;
  NatMov_Est := FieldByName('Mov_Est').AsString;
  NatGera_Dupl := FieldByName('Gera_Dupl').AsString;
 end;
 Close;
end;
...
function TConsultarNatureza.Realiza_calc_credpres: string;
begin
  Result := NatRealiza_calc_credpres;
end;

function TConsultarNatureza.Mov_Est: string;
begin
  Result := NatMov_Est;
end;

function TConsultarNatureza.Gera_Dupl: string;
begin
  Result := NatGera_Dupl;
end;
