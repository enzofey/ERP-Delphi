...
uses
  ...
  Empresa,
  Natureza,
  CSTPIS, CSTCOFINS, CSTICMS, CSOSN, CSTIPI, ENQIPI, NCM, Unidade,
...
type
  TWelcome = class(TForm)
    ...
    Moeda: TMenuItem;
    Compras: TMenuItem;
    EntradaNFe: TMenuItem;
    EditorRelatorio: TMenuItem;
    Pagar: TMenuItem;
    ...
    procedure MoedaClick(Sender: TObject);
    procedure EntradaNFeClick(Sender: TObject);
    procedure EditorRelatorioClick(Sender: TObject);
...
procedure TWelcome.EntradaNFeClick(Sender: TObject);
begin
 AbrirAba(TEntradaNFForm, 'Entrada de NF-e')
end;
...
procedure TWelcome.UnidadeClick(Sender: TObject);
begin
  AbrirAba(TCadUnidade, 'Cadastro de Unidade');
end;
...
procedure TWelcome.ReceberClick(Sender: TObject);
begin
 AbrirAba(TReceberForm, 'Receber');
end;

// PAGAR

procedure TWelcome.PagarClick(Sender: TObject);
begin
  AbrirAba(TPagarForm, 'Contas a Pagar');
end;
...
procedure TWelcome.EditorRelatorioClick(Sender: TObject);
begin
  AbrirAba(TEditorRelatorioFM, 'Editor de Relatórios');
end;
...
procedure TWelcome.MoedaClick(Sender: TObject);
begin
 AbrirAba(TCadMoeda, 'Cadastro de Moeda');
end;
