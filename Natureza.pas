...
begin
 ...
 begin
  ...
  ParamByName('cst').AsString := ENQIPI;
  Open;

  EdtAcessoDescricaoENQIPI.text := FieldByName('Descricao').AsString;
 end;
end;
...
begin
 ...
 with CadNaturezaDM.qryAcesso do
 begin
  SQL.Clear;
  SQL.Add('select * from cadnatureza');
  temwhere := false;
  ...
  if cst_icms <> '' then begin
   if temwhere then begin
    SQL.Add('and cst_icms = :cst_icms');
   end
   else begin
    SQL.Add('where cst_icms = :cst_icms');
    temwhere := true;
   end;
  ParamByName('cst_icms').AsString := cst_icms;
  end;
  ...
  if csosn <> '' then begin
   if temwhere then begin
    SQL.Add('and csosn = :csosn');
   end
   else begin
    SQL.Add('where csosn = :csosn');
    temwhere := true;
   end;
  ParamByName('csosn').AsString := csosn;
  end;
  ...
  if CST_IPI <> '' then begin
   if temwhere then begin
    SQL.Add('and CST_IPI = :CST_IPI');
   end
   else begin
    SQL.Add('where CST_IPI = :CST_IPI');
    temwhere := true;
   end;
  ParamByName('CST_IPI').AsString := CST_IPI;
  end;
  ...
  if ENQ_IPI <> '' then begin
   if temwhere then begin
    SQL.Add('and ENQ_IPI = :ENQ_IPI');
   end
   else begin
    SQL.Add('where ENQ_IPI = :ENQ_IPI');
    temwhere := true;
   end;
  ParamByName('ENQ_IPI').AsString := ENQ_IPI;
  end;
  ...
  if CST_PIS <> '' then begin
   if temwhere then begin
    SQL.Add('and CST_PIS = :CST_PIS');
   end
   else begin
    SQL.Add('where CST_PIS = :CST_PIS');
    temwhere := true;
   end;
  ParamByName('CST_PIS').AsString := CST_PIS;
  end;
  ...
  if CST_COFINS <> '' then begin
   if temwhere then begin
    SQL.Add('and CST_COFINS = :CST_COFINS');
   end
   else begin
    SQL.Add('where CST_COFINS = :CST_COFINS');
    temwhere := true;
   end;
  ParamByName('CST_COFINS').AsString := CST_COFINS;
  end;
