 ...
 if EdtPrazo8.Text <> '' then Inc(qtde_parcelas);
  ...
  try
    ...
    begin
      ...
      if CSOSN <> '' then begin
      FatGeralDM.qryModoCSOSN.SQL.Clear;
      FatGeralDM.qryModoCSOSN.SQL.Text :=
      'select * from cadcsosn where csosn = :csosn';
      FatGeralDM.qryModoCSOSN.ParamByName('csosn').AsString := csosn;
      FatGeralDM.qryModoCSOSN.Open;
       if FatGeralDM.qryModoCSOSN.FieldByName('modo').AsString = 'I' then begin
       Val_ICMS := 0;
       NIGrid.Cells[13,i] := '0';
      ...
      FatGeralDM.qryModoICMS.SQL.Clear;
      FatGeralDM.qryModoICMS.SQL.Text :=
      'select * from cadcsticms where cst = :cst_icms';
      FatGeralDM.qryModoICMS.ParamByName('cst_icms').AsString := cst_icms;
      FatGeralDM.qryModoICMS.Open;
       if FatGeralDM.qryModoICMS.FieldByName('modo').AsString = 'I' then begin
       Val_ICMS := 0;
       NIGrid.Cells[13,i] := '0';
      ...
      FatGeralDM.qryModoIPI.SQL.Clear;
      FatGeralDM.qryModoIPI.SQL.Text :=
      'select * from cadcstipi where cst = :cst_ipi';
      FatGeralDM.qryModoIPI.ParamByName('cst_ipi').AsString := CST_IPI;
      FatGeralDM.qryModoIPI.Open;
      if FatGeralDM.qryModoIPI.FieldByName('modo').AsString = 'I' then begin
      Val_IPI := 0;
      NIGrid.Cells[18,i] := '0';
      ...
      FatGeralDM.qryModoPIS.SQL.Text :=
      'select * from cadcstpis where cst = :cst_pis';
      FatGeralDM.qryModoPIS.ParamByName('cst_pis').AsString := CST_PIS;
      FatGeralDM.qryModoPIS.Open;
      if FatGeralDM.qryModoPIS.FieldByName('modo').AsString = 'I' then begin
      Val_PIS := 0;
      NIGrid.Cells[22,i] := '0';
      ...
      FatGeralDM.qryModoCOFINS.SQL.Text :=
      'select * from cadcstcofins where cst = :cst_cofins';
      FatGeralDM.qryModoCOFINS.ParamByName('cst_cofins').AsString := cst_cofins;
      FatGeralDM.qryModoCOFINS.Open;
      if FatGeralDM.qryModoCOFINS.FieldByName('modo').AsString = 'I' then begin
      Val_COFINS := 0;
      NIGrid.Cells[25,i] := '0';
      ...
      FatGeralDM.SelectQuery.SQL.Clear;
      FatGeralDM.SelectQuery.SQL.Text :=
      'SELECT qtde FROM estoque WHERE codigo = :codigo AND cor = :cor ' +
      'AND tamanho = :tamanho AND deposito = :deposito AND lote = :lote ' +
      'AND qtde >= :qtde';
      FatGeralDM.SelectQuery.ParamByName('codigo').AsString := Produto;
      FatGeralDM.SelectQuery.ParamByName('cor').AsString := Cor;
      FatGeralDM.SelectQuery.ParamByName('tamanho').AsString := Tamanho;
      FatGeralDM.SelectQuery.ParamByName('deposito').AsString := Deposito;
      FatGeralDM.SelectQuery.ParamByName('lote').AsString := Lote;
      FatGeralDM.SelectQuery.ParamByName('qtde').AsFloat := Qtde;
      FatGeralDM.SelectQuery.Open;

       if FatGeralDM.SelectQuery.IsEmpty then begin
      ...
      FatGeralDM.InsertNOTAITEN.SQL.Text :=
      ...
      'Qtde, Preco_Uni, Valor, ALIQ_ICMS, Val_Base_ICMS, Val_ICMS, ALIQ_IPI, Val_Base_IPI, Val_IPI, ALIQ_COFINS, Val_COFINS, ALIQ_PIS, ' +
      'Val_PIS, Val_Base_PIS_COFINS, Val_Desconto, Val_Frete) VALUES ' +
      '(:ID_NOTA, :fatura, :EMP_ID, :Serie, :Codigo, :Cor, :Tam, :Deposito, :Lote, :Natureza, :CST_ICMS, :CSOSN, :CST_IPI, :ENQ_IPI, :CST_PIS, :CST_COFINS, :cBenef, :cCredPres, ' +
      ':Qtde, :Preco_Uni, :Valor, :ALIQ_ICMS, :Val_Base_ICMS, :Val_ICMS, :ALIQ_IPI, :Val_Base_IPI, :Val_IPI, :ALIQ_COFINS, :Val_COFINS, :ALIQ_PIS, ' +
      ':Val_PIS, :Val_Base_PIS_COFINS, :Val_Desconto, :Val_Frete)';

      FatGeralDM.InsertNOTAITEN.ParamByName('ID_NOTA').AsInteger := ID_NOTA;
      FatGeralDM.InsertNOTAITEN.ParamByName('Fatura').AsString := Fatura;
      FatGeralDM.InsertNOTAITEN.ParamByName('EMP_ID').AsString := EmpresaLogada;
      FatGeralDM.InsertNOTAITEN.ParamByName('Serie').AsString := serie;
      FatGeralDM.InsertNOTAITEN.ParamByName('Codigo').AsString := Produto;
      FatGeralDM.InsertNOTAITEN.ParamByName('Cor').AsString := Cor;
      FatGeralDM.InsertNOTAITEN.ParamByName('Tam').AsString := Tamanho;
      FatGeralDM.InsertNOTAITEN.ParamByName('Deposito').AsString := Deposito;
      FatGeralDM.InsertNOTAITEN.ParamByName('Lote').AsString := Lote;
      FatGeralDM.InsertNOTAITEN.ParamByName('natureza').AsString := Natureza;
      FatGeralDM.InsertNOTAITEN.ParamByName('CST_ICMS').AsString := CST_ICMS;
      FatGeralDM.InsertNOTAITEN.ParamByName('CSOSN').AsString := CSOSN;
      FatGeralDM.InsertNOTAITEN.ParamByName('CST_IPI').AsString := CST_IPI;
      FatGeralDM.InsertNOTAITEN.ParamByName('ENQ_IPI').AsString := ENQ_IPI;
      FatGeralDM.InsertNOTAITEN.ParamByName('CST_PIS').AsString := CST_PIS;
      FatGeralDM.InsertNOTAITEN.ParamByName('CST_COFINS').AsString := CST_COFINS;
      FatGeralDM.InsertNOTAITEN.ParamByName('cBenef').AsString := cBenef;
      FatGeralDM.InsertNOTAITEN.ParamByName('cCredPres').AsString := cCredPres;
      FatGeralDM.InsertNOTAITEN.ParamByName('Qtde').AsFloat := Qtde;
      FatGeralDM.InsertNOTAITEN.ParamByName('Preco_Uni').AsFloat := Preco_Uni;
      FatGeralDM.InsertNOTAITEN.ParamByName('Valor').AsFloat := Valor;
      FatGeralDM.InsertNOTAITEN.ParamByName('ALIQ_ICMS').AsFloat := ALIQ_ICMS;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Base_ICMS').AsFloat := Base_ICMS;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_ICMS').AsFloat := Val_ICMS;
      FatGeralDM.InsertNOTAITEN.ParamByName('ALIQ_IPI').AsFloat := ALIQ_IPI;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Base_IPI').AsFloat := Base_IPI;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_IPI').AsFloat := Val_IPI;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Base_PIS_COFINS').AsFloat := Val_Base_PIS_COFINS;
      FatGeralDM.InsertNOTAITEN.ParamByName('ALIQ_COFINS').AsFloat := ALIQ_COFINS;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_COFINS').AsFloat := Val_COFINS;
      FatGeralDM.InsertNOTAITEN.ParamByName('ALIQ_PIS').AsFloat := ALIQ_PIS;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_PIS').AsFloat := Val_PIS;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Desconto').AsFloat := Val_Desconto;
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Frete').AsFloat := Val_Frete;
      FatGeralDM.InsertNOTAITEN.ExecSQL;
      ...
      'Gravado itens da nota na fatura: ' + Fatura + ' no emp_id: ' + EmpresaLogada + ' na série: ' + serie;
      LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
     ...
     if CBMovEst.ItemIndex = 0 then begin
      FatGeralDM.UpdateEstoque.SQL.Text :=
      'UPDATE estoque SET qtde = (qtde - :qtde) WHERE codigo = :codigo AND cor = :cor AND deposito = :deposito AND lote = :lote ' +
      'AND tamanho = :tamanho';
      FatGeralDM.UpdateEstoque.ParamByName('Codigo').AsString := Produto;
      FatGeralDM.UpdateEstoque.ParamByName('Cor').AsString := Cor;
      FatGeralDM.UpdateEstoque.ParamByName('tamanho').AsString := Tamanho;
      FatGeralDM.UpdateEstoque.ParamByName('Deposito').AsString := Deposito;
      FatGeralDM.UpdateEstoque.ParamByName('Lote').AsString := Lote;
      FatGeralDM.UpdateEstoque.ParamByName('qtde').AsFloat := Qtde;
      FatGeralDM.UpdateEstoque.ExecSQL;

      LogsDM.InserirLog.SQL.Text :=
      'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
      LogsDM.InserirLog. ParamByName('descricao').AsString :=
      'Alterou as quantidades no estoque pelo faturamento da nota: ' + Fatura;
      LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
      LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
      LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
      LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
      ...
      FatGeralDM.InsertProdMov.SQL.Text :=
      ...
      FatGeralDM.InsertProdMov.ParamByName('codigo').AsString := Produto;
      FatGeralDM.InsertProdMov.ParamByName('cor').AsString := Cor;
      FatGeralDM.InsertProdMov.ParamByName('tamanho').AsString := Tamanho;
      FatGeralDM.InsertProdMov.ParamByName('deposito').AsString := Deposito;
      FatGeralDM.InsertProdMov.ParamByName('lote').AsString := Lote;
      FatGeralDM.InsertProdMov.ParamByName('qtde').AsFloat := Qtde;
      FatGeralDM.InsertProdMov.ParamByName('data').AsDateTime := Now;
      FatGeralDM.InsertProdMov.ParamByName('tipo').AsString := 'S';
      FatGeralDM.InsertProdMov.ParamByName('Usuario').AsString := UsuarioLogado;
      FatGeralDM.InsertProdMov.ParamByName('OBS').AsString :=
      'Movimentação realizada a partir da gravação da nota: ' + Fatura + ' na série: ' + serie;
      FatGeralDM.InsertProdMov.ExecSQL;

      LogsDM.InserirLog.SQL.Text :=
      'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
      LogsDM.InserirLog. ParamByName('descricao').AsString :=
      'Gravou a movimentação dos itens da nota: ' + Fatura + ' no emp_id: ' + EmpresaLogada;
      LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
      LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
      LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
      LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertNOTA.SQL.Text :=
    ...
    'valor_ipi, valor_base_ipi, valor_cofins, valor_pis, ' +
    'valor_base_pis_cofins, valor_desconto, quantidade, aliq_icms, aliq_ipi, aliq_pis, ' +
    'aliq_cofins, impresso, dados_adicionais, especie, volumes, pesob, pesol, ' +
    'presenca, modfrete) ' +
    'VALUES (:fatura, :EMP_ID, :Serie, :Codcli, :dtemissao, :dtsaida, :Natureza, ' +
    ':valor_produtos, :valor_total, :valor_icms, :valor_base_icms, :valor_frete, ' +
    ':valor_ipi, :valor_base_ipi, :valor_cofins, :valor_pis, ' +
    ':valor_base_pis_cofins, :valor_desconto, :quantidade, :aliq_icms, :aliq_ipi, :aliq_pis, ' +
    ':aliq_cofins, :impresso, :dados_adicionais, :especie, :volumes, :pesob, :pesol, ' +
    ...
    FatGeralDM.InsertNOTA.ParamByName('Fatura').AsString := Fatura;
    FatGeralDM.InsertNOTA.ParamByName('EMP_ID').AsString := EmpresaLogada;
    FatGeralDM.InsertNOTA.ParamByName('Serie').AsString := serie;
    FatGeralDM.InsertNOTA.ParamByName('Codcli').AsString := entidade;
    FatGeralDM.InsertNOTA.ParamByName('dtemissao').AsDateTime := DtEmissao.DateTime;
    FatGeralDM.InsertNOTA.ParamByName('dtsaida').AsDateTime := DtSaida.DateTime;
    FatGeralDM.InsertNOTA.ParamByName('natureza').AsString := EdtNatureza.Text;
    FatGeralDM.InsertNOTA.ParamByName('valor_produtos').AsFloat := valor_produtos;
    FatGeralDM.InsertNOTA.ParamByName('valor_total').AsFloat := valor_total;
    FatGeralDM.InsertNOTA.ParamByName('valor_icms').AsFloat := valor_icms;
    FatGeralDM.InsertNOTA.ParamByName('valor_base_icms').AsFloat := valor_base_icms;
    FatGeralDM.InsertNOTA.ParamByName('valor_frete').AsString := EdtValFrete.Text;
    FatGeralDM.InsertNOTA.ParamByName('valor_ipi').AsFloat := valor_ipi;
    FatGeralDM.InsertNOTA.ParamByName('valor_base_ipi').AsFloat := valor_base_ipi;
    FatGeralDM.InsertNOTA.ParamByName('valor_cofins').AsFloat := valor_cofins;
    FatGeralDM.InsertNOTA.ParamByName('valor_base_pis_cofins').AsFloat := valor_base_pis_cofins;
    FatGeralDM.InsertNOTA.ParamByName('valor_pis').AsFloat := valor_pis;
    FatGeralDM.InsertNOTA.ParamByName('valor_desconto').AsString := EdtValDesconto.Text;
    FatGeralDM.InsertNOTA.ParamByName('quantidade').AsFloat := quantidade;
    FatGeralDM.InsertNOTA.ParamByName('aliq_icms').AsFloat := aliq_icms_nota;
    FatGeralDM.InsertNOTA.ParamByName('aliq_ipi').AsFloat := aliq_ipi_nota;
    FatGeralDM.InsertNOTA.ParamByName('aliq_pis').AsFloat := aliq_pis_nota;
    FatGeralDM.InsertNOTA.ParamByName('aliq_cofins').AsFloat := aliq_cofins_nota;
    FatGeralDM.InsertNOTA.ParamByName('dados_adicionais').AsString := dados_adicionais;
    FatGeralDM.InsertNOTA.ParamByName('especie').AsString := especie;
    FatGeralDM.InsertNOTA.ParamByName('pesob').AsString := pesob;
    FatGeralDM.InsertNOTA.ParamByName('pesol').AsString := pesol;
    FatGeralDM.InsertNOTA.ParamByName('presenca').AsString := presenca;
    FatGeralDM.InsertNOTA.ParamByName('modfrete').AsString := modfrete;
    FatGeralDM.InsertNOTA.ParamByName('volumes').AsString := volumes;
    FatGeralDM.InsertNOTA.ParamByName('Impresso').AsString := 'N';
    FatGeralDM.InsertNOTA.ExecSQL;

    LogsDM.InserirLog.SQL.Text :=
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'O usuário: ' + UsuarioLogado + ' faturou a nota: ' + fatura + ' na série: ' + serie + ' no emp_id: ' + EmpresaLogada + ' para o cliente: ' + entidade;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertNOTA_FATURA.SQL.CLear;
    FatGeralDM.InsertNOTA_FATURA.SQL.Text :=
    'insert into nota_fatura (numero, serie, emp_id) values (:numero, :serie, :emp_id)';
    FatGeralDM.InsertNOTA_FATURA.ParamByName('numero').AsString := fatura;
    FatGeralDM.InsertNOTA_FATURA.ParamByName('serie').AsString := serie;
    FatGeralDM.InsertNOTA_FATURA.ParamByName('emp_id').AsString := empresalogada;
    FatGeralDM.InsertNOTA_FATURA.ExecSQL;

    LogsDM.InserirLog.SQL.Text :=
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravou numeração da nota na tabela nota_numero no número: ' + Fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
   ...
   if CBGeraDupl.ItemIndex = 0 then begin
    ...
    FatGeralDM.InsertRECEBER.SQL.Clear;
    FatGeralDM.InsertRECEBER.SQL.Text :=
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '1';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '1';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;

    LogsDM.InserirLog.SQL.Text :=
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '1') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '2';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '2';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '2') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '3';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '3';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '3') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '4';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '4';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '4') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '5';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '5';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '5') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '6';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '6';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '6') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '7';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '7';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '7') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
    ...
    FatGeralDM.InsertRECEBER.ParamByName('dtemissao').AsDate := Now;
    FatGeralDM.InsertRECEBER.ParamByName('dtvencto').AsDate := Now + Dias;
    FatGeralDM.InsertRECEBER.ParamByName('numero').AsString := fatura + '-' + Empresalogada + '-' + serie + '/' + '8';
    FatGeralDM.InsertRECEBER.ParamByName('entidade').AsString := entidade;
    FatGeralDM.InsertRECEBER.ParamByName('fatura').AsString := Fatura;
    FatGeralDM.InsertRECEBER.ParamByName('valor').AsFloat := valor_total;
    FatGeralDM.InsertRECEBER.ParamByName('valor_pago').AsFloat := 0;
    FatGeralDM.InsertRECEBER.ParamByName('status').AsString := 'DUPL';
    FatGeralDM.InsertRECEBER.ParamByName('moeda').AsString := moeda;
    FatGeralDM.InsertRECEBER.ParamByName('parcela').AsString := '8';
    FatGeralDM.InsertRECEBER.ParamByName('valor_parcela').AsFloat := valor_parcela;
    FatGeralDM.InsertRECEBER.ExecSQL;
    ...
    'INSERT INTO logs (descricao, tela, data, emp_id, usuario) VALUES (:descricao, :tela, :data, :emp_id, :usuario)';
    LogsDM.InserirLog. ParamByName('descricao').AsString :=
    'Gravado a duplicata ' + (fatura + '-' + Empresalogada + '-' + serie + '/' + '8') + ' pelo faturamento da nota ' + fatura;
    LogsDM.InserirLog.ParamByName('tela').AsString := 'FatGeral';
    LogsDM.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
    LogsDM.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
    LogsDM.InserirLog.ParamByName('data').AsDateTime := Now;
...
begin
  ...
  case NIGrid.Col of
    ...
    begin
     ...
     CadDepositoDM.ConsultarDeposito.ParamByName('ativo').AsString := 'S';
    ...
    begin
     ...
     CadCSTPISDM.InsertQuery.ParamByName('ativo').AsString := 'S';
...
begin
 ...
 EdtNomeEntidade.Text := CadEntidadeDM.ConsultarEntidade.FieldByName('nome').AsString;
end;
...
begin
 ...
 CadNaturezaDM.ConsultarNatureza.SQL.Clear;
 CadNaturezaDM.ConsultarNatureza.SQL.Text :=
 'select * from cadnatureza where natureza = :natureza and ativo = :ativo';
 CadNaturezaDM.ConsultarNatureza.ParamByName('ativo').AsString := 'S';
 CadNaturezaDM.ConsultarNatureza.ParamByName('natureza').AsString := natureza;
 CadNaturezaDM.ConsultarNatureza.Open;

 EdtDescricaoNatureza.Text := CadNaturezaDM.ConsultarNatureza.FieldByName('descricao').AsString;

 Gera_Dupl := CadNaturezaDM.ConsultarNatureza.FieldByName('Gera_DUPL').AsString;
 ...
 Mov_Est := CadNaturezaDM.ConsultarNatureza.FieldByName('Mov_Est').AsString;
 ...
 cBenef := CadNaturezaDM.ConsultarNatureza.FieldByName('cBenef').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[28,i] := cBenef;

 cCredPres := CadNaturezaDM.ConsultarNatureza.FieldByName('cCredPres').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[29,i] := cCredPres;

 enq_ipi := CadNaturezaDM.ConsultarNatureza.FieldByName('enq_ipi').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[15,i] := enq_ipi;

 cst_icms := CadNaturezaDM.ConsultarNatureza.FieldByName('cst_icms').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[9,i] := cst_icms;

 csosn := CadNaturezaDM.ConsultarNatureza.FieldByName('csosn').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[10,i] := csosn;

 cst_ipi := CadNaturezaDM.ConsultarNatureza.FieldByName('cst_ipi').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[14,i] := cst_ipi;

 cst_pis := CadNaturezaDM.ConsultarNatureza.FieldByName('cst_pis').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[19,i] := cst_pis;

 cst_cofins := CadNaturezaDM.ConsultarNatureza.FieldByName('cst_cofins').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[23,i] := cst_cofins;

 aliq_icms := CadNaturezaDM.ConsultarNatureza.FieldByName('aliq_icms').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[11,i] := aliq_icms;

 aliq_ipi := CadNaturezaDM.ConsultarNatureza.FieldByName('aliq_ipi').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[16,i] := aliq_ipi;

 aliq_pis := CadNaturezaDM.ConsultarNatureza.FieldByName('aliq_pis').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
 NIGrid.Cells[20,i] := aliq_pis;

 aliq_cofins := CadNaturezaDM.ConsultarNatureza.FieldByName('aliq_cofins').AsString;
 for i := 1 to NIGrid.RowCount - 1 do
