...
begin
  FaCodigo := CadFaixaTamanhoDM.ConsultarFaixa.FieldByName('codigo').AsString;
  FaDescricao := CadFaixaTamanhoDM.ConsultarFaixa.FieldByName('descricao').AsString;
  FaAtivo := CadFaixaTamanhoDM.ConsultarFaixa.FieldByName('ativo').AsString;
  Close;
end;
end.
