...
begin
 ...
 if CadUsuarioDataModule.SenhaQuery.IsEmpty then begin
 ...
 CadUsuarioDataModule.SenhaQuery.ParamByName('senha_alterada').AsString := 'S';
 try
...
begin
  ...
  CadUsuarioDataModule.ConsultarUsuario.ParamByName('ativo').AsString := 'S';
