...
begin
  ...
  NatRealiza_calc_credpres := CadNaturezaDM.ConsultarNatureza.FieldByName('Realiza_calc_credpres').AsString;
  NatMov_Est := CadNaturezaDM.ConsultarNatureza.FieldByName('Mov_Est').AsString;
  NatGera_Dupl := CadNaturezaDM.ConsultarNatureza.FieldByName('Gera_Dupl').AsString;
  Close;
end;
