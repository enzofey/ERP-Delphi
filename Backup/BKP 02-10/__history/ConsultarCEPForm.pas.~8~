...
begin
  CepCodigo := CadCepDM.ConsultarCEP.FieldByName('Codigo').AsString;
  CepCep := CadCepDM.ConsultarCEP.FieldByName('CEP').AsString;
  CepCidade := CadCepDM.ConsultarCEP.FieldByName('Cidade').AsString;
  CepEstado := CadCepDM.ConsultarCEP.FieldByName('Estado').AsString;
  CepPais := CadCepDM.ConsultarCEP.FieldByName('Pais').AsString;
  CepAtivo := CadCepDM.ConsultarCEP.FieldByName('ativo').AsString;
  Close;
end;
