...
begin
 ...
 CadCidadeDataModule.SelectQuery.SQL.Clear;
 CadCidadeDataModule.SelectQuery.SQL.Text :=
 'SELECT * FROM cadcidade WHERE codigo=:codigo';
 CadCidadeDataModule.SelectQuery.ParamByName('codigo').AsString := codigo;
 CadCidadeDataModule.SelectQuery.Open;

 if NOT CadCidadeDataModule.SelectQuery.IsEmpty then begin
 showmessage('Cidade já cadastrada!');
 end
 else begin

 CadCidadeDataModule.InsertQuery.Close;
 CadCidadeDataModule.InsertQuery.SQL.Clear;
 CadCidadeDataModule.InsertQuery.SQL.Text :=
 'insert into cadcidade (codigo, cidade, pais, estado, ativo) values (:codigo, :cidade, :pais, :estado, :ativo)';
 CadCidadeDataModule.InsertQuery.ParamByName('codigo').AsString := Codigo;
 CadCidadeDataModule.InsertQuery.ParamByName('cidade').AsString := cidade;
 CadCidadeDataModule.InsertQuery.ParamByName('pais').AsString := pais;
 CadCidadeDataModule.InsertQuery.ParamByName('estado').AsString := estado;
 CadCidadeDataModule.InsertQuery.ParamByName('ativo').AsString := ativo;
 ...
 LogModule.InserirLog.ParamByName('tela').AsString := 'CadCidade';
 ...
 try
 CadCidadeDataModule.InsertQuery.ExecSQL;
...
begin
 ...
 CadCidadeDataModule.UpdateQuery.SQL.Text :=
 'update cadcidade set cidade = :cidade, estado = :estado, pais = :pais, ativo = :ativo where codigo = :codigo';
 CadCidadeDataModule.UpdateQuery.ParamByName('cidade').AsString := Cidade;
 CadCidadeDataModule.UpdateQuery.ParamByName('ativo').AsString := ativo;
 CadCidadeDataModule.UpdateQuery.ParamByName('estado').AsString := estado;
 CadCidadeDataModule.UpdateQuery.ParamByName('pais').AsString := pais;
 CadCidadeDataModule.UpdateQuery.ParamByName('codigo').AsString := codigo;
 ...
 try
 CadCidadeDataModule.UpdateQuery.ExecSQL;
 LogModule.InserirLog.ExecSQL;
...
procedure TCadCidade.btnConsultarClick(Sender: TObject);
 var codigo, cidade, pais, estado, ativo: string;
begin
  CadCidadeDataModule.ConsultarCidade.SQL.Clear;
  CadCidadeDataModule.ConsultarCidade.SQL.Text :=
  'select * from cadcidade';
  CadCidadeDataModule.ConsultarCidade.Open;
...
begin
 ...
 CadCidadeDataModule.SelectQuery.Close;
 CadCidadeDataModule.SelectQuery.SQL.Clear;
 CadCidadeDataModule.SelectQuery.SQL.Text :=
 'select * from cadCEP where cidade = :cidade';
 CadCidadeDataModule.SelectQuery.ParamByName('cidade').AsString := cidade;
 CadCidadeDataModule.SelectQuery.Open;
 ...
 CadCidadeDataModule.DeleteQuery.SQL.Text :=
 'delete from cadcidade where codigo = :codigo';
 CadCidadeDataModule.DeleteQuery.ParamByName('codigo').AsString := codigo;
 ...
 LogModule.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
 try
 CadCidadeDataModule.DeleteQuery.ExecSQL;
 LogModule.InserirLog.ExecSQL;
...
begin
  ...
  CadEstadoModule.ConsultarEstado.Parambyname('ativo').AsString := 'S';
