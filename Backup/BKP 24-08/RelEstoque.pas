...
begin
  ...
  EstoqueDataModule.ConsultarEstoque.Close;
  EstoqueDataModule.ConsultarEstoque.SQL.Clear;
  EstoqueDataModule.ConsultarEstoque.SQL.Text :=
  ...
  if temwhere then begin
    EstoqueDataModule.ConsultarEstoque.SQL.Add('AND cp.codigo = :codigo');
    EstoqueDataModule.ConsultarEstoque.ParamByName('codigo').AsString := produto;
  end
  else begin
    EstoqueDataModule.ConsultarEstoque.SQL.Add('WHERE cp.codigo = :codigo');
    EstoqueDataModule.ConsultarEstoque.ParamByName('codigo').AsString := produto;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDataModule.ConsultarEstoque.SQL.Add('AND cc.codigo = :cor');
      EstoqueDataModule.ConsultarEstoque.ParamByName('cor').AsString := cor;
  end
  else begin
    EstoqueDataModule.ConsultarEstoque.SQL.Add('WHERE cc.codigo = :cor');
    EstoqueDataModule.ConsultarEstoque.ParamByName('cor').AsString := cor;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDataModule.ConsultarEstoque.SQL.Add('AND cd.codigo = :deposito');
      EstoqueDataModule.ConsultarEstoque.ParamByName('deposito').AsString := deposito;
  end
  else begin
    EstoqueDataModule.ConsultarEstoque.SQL.Add('WHERE cd.codigo = :deposito');
    EstoqueDataModule.ConsultarEstoque.ParamByName('deposito').AsString := deposito;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDataModule.ConsultarEstoque.SQL.Add('AND ct.codigo = :tamanho');
      EstoqueDataModule.ConsultarEstoque.ParamByName('tamanho').AsString := tamanho;
  end
  else begin
    EstoqueDataModule.ConsultarEstoque.SQL.Add('WHERE ct.codigo = :tamanho');
    EstoqueDataModule.ConsultarEstoque.ParamByName('tamanho').AsString := tamanho;
  end;
  end;

  EstoqueDataModule.ConsultarEstoque.Open;
