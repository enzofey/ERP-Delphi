...
begin
 ...
 if CadDepositoDataModule.SelectQuery.IsEmpty then begin
 ShowMessage('Deposito não encontrado!')
 end
 else begin
 CadDepositoDataModule.DeleteQuery.SQL.Clear;
 CadDepositoDataModule.DeleteQuery.SQL.Text := 'delete from caddeposito where codigo = :codigo';
 CadDepositoDataModule.DeleteQuery.ParamByName('codigo').AsString := codigo;
 ...
 LogModule.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
 try
 CadDepositoDataModule.DeleteQuery.ExecSQL;
 LogModule.InserirLog.ExecSQL;
