...
begin
  ...
  'insert into cadENQIPI (CST, Descricao) values (:CST, :Descricao)';
...
begin
  ...
  'update cadENQIPI set descricao = :descricao where CST = :CST';
...
begin
 EdtCST.Text := CadENQIPIDataModule.GridQuery.FieldByName('CST').AsString;
 EdtDescricao.Text := CadENQIPIDataModule.GridQuery.FieldByName('Descricao').AsString;
end;
