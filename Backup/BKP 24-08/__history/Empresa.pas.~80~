...
begin
  ...
  CadEmpresaDataModule.FormShow.SQL.Clear;
  CadEmpresaDataModule.FormShow.Close;
  CadEmpresaDataModule.FormShow.SQL.Text :=
  'select * from empresa where emp_id = :emp_id';
  CadEmpresaDataModule.FormShow.ParamByName('EMP_ID').AsString := empresalogada;
  CadEmpresaDataModule.FormShow.Open;

  nome := CadEmpresaDataModule.FormShow.FieldByName('nome').AsString;
  CNPJ := CadEmpresaDataModule.FormShow.FieldByName('CNPJ').AsString;
  IE := CadEmpresaDataModule.FormShow.FieldByName('IE').AsString;
  Rua := CadEmpresaDataModule.FormShow.FieldByName('Rua').AsString;
  Numero := CadEmpresaDataModule.FormShow.FieldByName('Numero').AsString;
  Estado := CadEmpresaDataModule.FormShow.FieldByName('Estado').AsString;
  Bairro := CadEmpresaDataModule.FormShow.FieldByName('Bairro').AsString;
  Cidade := CadEmpresaDataModule.FormShow.FieldByName('Cidade').AsString;
  Pais := CadEmpresaDataModule.FormShow.FieldByName('Pais').AsString;
  complemento := CadEmpresaDataModule.FormShow.FieldByName('complemento').AsString;
  CEP := CadEmpresaDataModule.FormShow.FieldByName('cep').AsString;
  serie := CadEmpresaDataModule.FormShow.FieldByName('serie').AsString;
  EMP_ID := CadEmpresaDataModule.FormShow.FieldByName('EMP_ID').AsString;
  CRT := CadEmpresaDataModule.FormShow.FieldByName('CRT').AsString;
  Fantasia := CadEmpresaDataModule.FormShow.FieldByName('Fantasia').AsString;
  Telefone := CadEmpresaDataModule.FormShow.FieldByName('Telefone').AsString;
