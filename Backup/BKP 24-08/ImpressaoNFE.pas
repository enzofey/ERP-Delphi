...
begin
    ...
    ImpressaoNFEFormDataModule.TransmitirNotaQuery.SQL.Text :=
      'SELECT N.ID, N.Fatura as nota_fatura, N.EMP_ID, N.Serie, N.Codcli, N.dtEmissao, N.dtSaida, ' +
      ...
      'ni.ID_NOTA, ni.fatura as notaiten_fatura, ni.EMP_ID, ni.Serie, ni.Codigo as codigo_produto, ni.Tam, ni.Cor, ' +
    ...
    cUF := ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('codigo_estado').AsString;
    AAMM := FormatDateTime('yyMM', Now);
    CNPJEmi := ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('Emp_CNPJ').AsString;
    serie := FormatFloat('000', ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('serie').AsInteger);
    fatura := FormatFloat('000000000', ImpressaoNFEFormDataModule.TransmitirNotaQuery.ParamByName('fatura').AsInteger);
  ...
  try
    ...
    prodnode.AddChild('qCom').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('qtde_itens').AsFloat);
    prodnode.AddChild('vUnCom').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('preco_uni').AsFloat);
    prodnode.AddChild('vProd').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_item').AsFloat);
    ...
    prodnode.AddChild('qTrib').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('qtde_itens').AsFloat);
    prodnode.AddChild('vUnTrib').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('preco_uni').AsFloat);
    ...
    PisALiqNode.AddChild('vBC').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('val_base_pis').AsFloat);
    PisALiqNode.AddChild('pPIS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('Aliq_PIS').AsFloat);
    PisALiqNode.AddChild('vPIS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('val_pis').AsFloat);
    ...
    COFINSALiqNode.AddChild('vBC').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('val_base_COFINS').AsFloat);
    COFINSALiqNode.AddChild('pCOFINS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('Aliq_COFINS').AsFloat);
    COFINSALiqNode.AddChild('vCOFINS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('val_COFINS').AsFloat);

    TotalNode := InfNFENode.AddChild('total');
    ICMSTotNode := TotalNode.AddChild('ICMSTot');
    ICMSTotNode.AddChild('vBC').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_base_icms').AsFloat);
    ICMSTotNode.AddChild('vICMS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_icms').AsFloat);
    ...
    ICMSTotNode.AddChild('vProd').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_produtos').AsFloat);
    ICMSTotNode.AddChild('vFrete').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_frete').AsFloat);
    ICMSTotNode.AddChild('vSeg').Text := '0.00';
    ICMSTotNode.AddChild('vDesc').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_desconto').AsFloat);
    ICMSTotNode.AddChild('vII').Text :=  '0.00';
    ICMSTotNode.AddChild('vIPI').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_ipi').AsFloat);
    ICMSTotNode.AddChild('vIPIDevol').Text :=  '0.00';
    ICMSTotNode.AddChild('vPIS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_pis').AsFloat);
    ICMSTotNode.AddChild('vCOFINS').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_cofins').AsFloat);
    ICMSTotNode.AddChild('vOutro').Text := '0.00';
    ICMSTotNode.AddChild('vNF').Text := FormataValorNFe(ImpressaoNFEFormDataModule.TransmitirNotaQuery.FieldByName('valor_total').AsFloat);
