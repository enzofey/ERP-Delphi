...
begin
  ...
  begin
    CBoxTamanho.Items.Add(MovSaidaDataModule.CBTamanho.FieldByName('codigo').AsString);
...
begin
 ...
 MovSaidaDataModule.updatequery.ParamByName('qtde').AsFloat := StrToFloat(qtde);
 ...
 MovSaidaDataModule.InsertQuery.ParamByName('qtde').AsFloat := StrToFloat(qtde);
 ...
 MovSaidaDataModule.InsertQuery.ParamByName('tipo').AsString := 'S';
 MovSaidaDataModule.InsertQuery.ParamByName('data').AsDateTime := Now;
 MovSaidaDataModule.InsertQuery.ParamByName('usuario').AsString := UsuarioLogado;
 MovSaidaDataModule.InsertQuery.ParamByName('emp_id').AsString := EmpresaLogada;
 ...
 LogModule.InserirLog.ParamByName('tela').AsString := 'MovSaida';
