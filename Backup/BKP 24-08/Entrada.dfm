object MovEntrada: TMovEntrada
  ...
  object Panel1: TPanel
    ...
    object CBoxProduto: TComboBox
      ...
      Enabled = False
      TabOrder = 3
      OnDropDown = CBoxProdutoDropDown
    end
    object CBoxCor: TComboBox
      Left = 111
      Top = 93
      Width = 145
      Height = 23
      ...
      Enabled = False
      TabOrder = 4
      OnDropDown = CBoxCorDropDown
    end
    object CBoxTamanho: TComboBox
      Left = 111
      Top = 141
      Width = 145
      Height = 23
      ...
      Enabled = False
      TabOrder = 5
      OnDropDown = CBoxTamanhoDropDown
    end
    object CBoxDeposito: TComboBox
      Left = 111
      Top = 189
      Width = 145
      Height = 23
      ...
      Enabled = False
      TabOrder = 6
      OnDropDown = CBoxDepositoDropDown
    end
