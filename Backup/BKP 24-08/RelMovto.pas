...
begin
  ...
  RelMovtoModule.ConsultarProdMov.SQL.Clear;
  RelMovtoModule.ConsultarProdMov.SQL.Text :=
  ...
  RelMovtoModule.ConsultarProdMov.SQL.Add('and cp.codigo = :codigo');
  RelMovtoModule.ConsultarProdMov.ParamByName('codigo').AsString := codigo;
  end
  else begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('where cp.codigo = :codigo');
  RelMovtoModule.ConsultarProdMov.ParamByName('codigo').AsString := codigo;
  end;
end;
  temwhere := true;
  ...
  begin
   if temwhere then begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('and cc.codigo = :cor');
  RelMovtoModule.ConsultarProdMov.ParamByName('cor').AsString := cor;
  end
  else begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('where cc.codigo = :cor');
  RelMovtoModule.ConsultarProdMov.ParamByName('cor').AsString := cor;
  end;
  end;
  temwhere := True;
  ...
  begin
   if temwhere then begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('and cd.codigo = :deposito');
  RelMovtoModule.ConsultarProdMov.ParamByName('deposito').AsString := deposito;
  end
  else begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('where cd.codigo = :deposito');
  RelMovtoModule.ConsultarProdMov.ParamByName('deposito').AsString := deposito;
  end;
  end;
  temwhere := True;
  ...
  begin
   if temwhere then begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('and ct.codigo = :tamanho');
  RelMovtoModule.ConsultarProdMov.ParamByName('tamanho').AsString := tamanho;
  end
  else begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('where ct.codigo = :tamanho');
  RelMovtoModule.ConsultarProdMov.ParamByName('tamanho').AsString := tamanho;
  end;
  end;
  temwhere := True;
  ...
  begin
   if temwhere then begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('and pm.tipo = :tipo');
  RelMovtoModule.ConsultarProdMov.ParamByName('tipo').AsString := tipo;
  end
  else begin
  RelMovtoModule.ConsultarProdMov.SQL.Add('where pm.tipo = :tipo');
  RelMovtoModule.ConsultarProdMov.ParamByName('tipo').AsString := tipo;
  end;
  end;
  temwhere := True;
  ...
  RelMovtoModule.ConsultarProdMov.Open;
...
begin
  ...
  if RelMovtoModule.IDQuery.IsEmpty then begin
