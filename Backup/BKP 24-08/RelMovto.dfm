object RelMovtoForm: TRelMovtoForm
  ...
  object Panel1: TPanel
    ...
    object SBApagarProduto: TSpeedButton
      Left = 244
      Top = 21
      Width = 23
      Height = 22
      OnClick = SBApagarProdutoClick
    end
    object SBApagarCor: TSpeedButton
      Left = 244
      Top = 62
      Width = 23
      Height = 22
      OnClick = SBApagarCorClick
    end
    object SBApagarDeposito: TSpeedButton
      Left = 244
      Top = 102
      Width = 23
      Height = 22
      OnClick = SBApagarDepositoClick
    end
    object SBApagarTamanho: TSpeedButton
      Left = 244
      Top = 142
      Width = 23
      Height = 22
      OnClick = SBApagarTamanhoClick
    end
    ...
    object Grid: TDBGrid
      ...
      Width = 1073
      Height = 417
      DataSource = RelMovtoModule.dsProdMov
      TabOrder = 0
