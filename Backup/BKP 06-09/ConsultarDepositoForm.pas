...
begin
  DCodigo := CadDepositoDM.ConsultarDeposito.FieldByName('codigo').AsString;
  DDescricao := CadDepositoDM.ConsultarDeposito.FieldByName('descricao').AsString;
  DAtivo := CadDepositoDM.ConsultarDeposito.FieldByName('ativo').AsString;
  Close;
end;
end.
