...
begin
 ...
 MovEntradaDataModule.InsertQuery.ParamByName('qtde').AsFloat := StrToFloat(qtde);
 ...
 MovEntradaDataModule.UpdateQuery.ParamByName('qtde').AsFloat := StrToFloat(qtde);
 ...
 MovEntradaDataModule.InsertProdMov.ParamByName('qtde').AsFloat := StrToFloat(qtde);
 MovEntradaDataModule.InsertProdMov.ParamByName('data').AsDateTime := Now;
 MovEntradaDataModule.InsertProdMov.ParamByName('tipo').AsString := 'E';
 MovEntradaDataModule.InsertProdMov.ParamByName('usuario').AsString := UsuarioLogado;
 ...
 LogModule.InserirLog.ParamByName('tela').AsString := 'MovEntrada';
