...
begin
  ...
  EstoqueDM.ConsultarEstoque.Close;
  EstoqueDM.ConsultarEstoque.SQL.Clear;
  EstoqueDM.ConsultarEstoque.SQL.Text :=
  ...
  if temwhere then begin
    EstoqueDM.ConsultarEstoque.SQL.Add('AND cp.codigo = :codigo');
    EstoqueDM.ConsultarEstoque.ParamByName('codigo').AsString := produto;
  end
  else begin
    EstoqueDM.ConsultarEstoque.SQL.Add('WHERE cp.codigo = :codigo');
    EstoqueDM.ConsultarEstoque.ParamByName('codigo').AsString := produto;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDM.ConsultarEstoque.SQL.Add('AND cc.codigo = :cor');
      EstoqueDM.ConsultarEstoque.ParamByName('cor').AsString := cor;
  end
  else begin
    EstoqueDM.ConsultarEstoque.SQL.Add('WHERE cc.codigo = :cor');
    EstoqueDM.ConsultarEstoque.ParamByName('cor').AsString := cor;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDM.ConsultarEstoque.SQL.Add('AND cd.codigo = :deposito');
      EstoqueDM.ConsultarEstoque.ParamByName('deposito').AsString := deposito;
  end
  else begin
    EstoqueDM.ConsultarEstoque.SQL.Add('WHERE cd.codigo = :deposito');
    EstoqueDM.ConsultarEstoque.ParamByName('deposito').AsString := deposito;
  end;
  end;
  temwhere := True;
  ...
  begin
    if temwhere then begin
      EstoqueDM.ConsultarEstoque.SQL.Add('AND ct.codigo = :tamanho');
      EstoqueDM.ConsultarEstoque.ParamByName('tamanho').AsString := tamanho;
  end
  else begin
    EstoqueDM.ConsultarEstoque.SQL.Add('WHERE ct.codigo = :tamanho');
    EstoqueDM.ConsultarEstoque.ParamByName('tamanho').AsString := tamanho;
  end;
  end;

  EstoqueDM.ConsultarEstoque.Open;
