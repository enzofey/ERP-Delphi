  ...
  try
    for i := 1 to NIGrid.RowCount - 1 do
     begin
      ...
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Base_COFINS').AsFloat := Base_COFINS;
      ...
      FatGeralDM.InsertNOTAITEN.ParamByName('Val_Base_PIS').AsFloat := Base_PIS;
      ...
      FatGeralDM.InsertProdMov.ParamByName('OBS').AsString := 'Movimentação realizada a partir da gravação da nota ' + serie;
    ...
    FatGeralDM.InsertNOTA.ParamByName('valor_base_cofins').AsFloat := valor_base_cofins;
    FatGeralDM.InsertNOTA.ParamByName('valor_pis').AsFloat := valor_pis;
    FatGeralDM.InsertNOTA.ParamByName('valor_base_pis').AsFloat := valor_base_pis;
...
begin
  case NIGrid.Col of
    ...
    begin
     ...
     CadProdutoDM.ConsultarProduto.ParamByName('ativo').AsString := 'S';
    ...
    begin
      ...
      CadCorDM.ConsultarCor.ParamByName('ativo').AsString := 'S';
    ...
    begin
      ...
      CadTamanhoDM.ConsultarTamanho.ParamByName('ativo').AsString := 'S';
