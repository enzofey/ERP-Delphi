...
begin
  PCodigo := CadProdutoDM.ConsultarProduto.FieldByName('codigo').AsString;
  PDescricao := CadProdutoDM.ConsultarProduto.FieldByName('descricao').AsString;
  PAtivo := CadProdutoDM.ConsultarProduto.FieldByName('ativo').AsString;
  PFaixa := CadProdutoDM.ConsultarProduto.FieldByName('faixa').AsString;
  PNCM := CadProdutoDM.ConsultarProduto.FieldByName('NCM').AsString;
  PUniCom := CadProdutoDM.ConsultarProduto.FieldByName('UniCom').AsString;
  PUniVenda := CadProdutoDM.ConsultarProduto.FieldByName('UniVenda').AsString;
  PBrinde := CadProdutoDM.ConsultarProduto.FieldByName('Brinde').AsString;
  POrigem := CadProdutoDM.ConsultarProduto.FieldByName('Origem').AsString;

  CadCorDM.CorEstoque.Close;
  CadCorDM.CorEstoque.SQL.Clear;
  CadCorDM.CorEstoque.SQL.Text :=
  ...
  CadCorDM.CorEstoque.ParamByName('codigo').AsString := PCodigo;
  CadCorDM.CorEstoque.Open;
  Close;
end;
end.
