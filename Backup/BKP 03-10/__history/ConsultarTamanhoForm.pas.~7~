...
uses
  ...
  Vcl.DBGrids, Vcl.ExtCtrls, TamanhoDataModule;
...
begin
  TCodigo := CadTamanhoDataModule.ConsultarTamanho.FieldByName('codigo').AsString;
  TDescricao := CadTamanhoDataModule.ConsultarTamanho.FieldByName('descricao').AsString;
  TAtivo := CadTamanhoDataModule.ConsultarTamanho.FieldByName('ativo').AsString;
  Close;
end;
end.
