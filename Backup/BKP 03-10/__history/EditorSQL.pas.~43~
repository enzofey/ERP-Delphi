...
begin
 ...
 EditorSQLModule.SelectQuery.SQL.Clear;
 EditorSQLModule.SelectQuery.Close;
 EditorSQLModule.SelectQuery.SQL.Text := EdtSQL.Text;
 EditorSQLModule.SelectQuery.Open;
 ...
 'Fez o select ' + SQL;
 LogModule.InserirLog.ParamByName('tela').AsString := 'EditorSQL';
...
begin
 ...
 LogModule.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
 try
 EditorSQLModule.SelectQuery.ExecSQL;
 LogModule.InserirLog.ExecSQL;
