...
begin
  ...
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_icms').AsString := aliq_icms;
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_ipi').AsString := aliq_ipi;
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_pis').AsString := aliq_pis;
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_cofins').AsString := aliq_cofins;
  CadNaturezaDataModule.InsertQuery.ParamByName('Aliq_Cred_Pres').AsString := aliq_cofins;
...
var natureza, descricao, tipo, ativo, cBenef, cCredPres, cst_icms, csosn, cst_ipi, enq_ipi, cst_pis, cst_cofins,
    aliq_icms, aliq_ipi, aliq_cofins, aliq_pis, Aliq_Cred_Pres, tela: string;
begin
  natureza := EdtNatureza.Text;
  descricao := EdtDescricao.Text;
  tipo := CBTipo.Text;
  ...
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_icms').AsString := aliq_icms;
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_ipi').AsString := aliq_ipi;
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_pis').AsString := aliq_pis;
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_cofins').AsString := aliq_cofins;
  CadNaturezaDataModule.UpdateQuery.ParamByName('Aliq_Cred_Pres').AsString := Aliq_Cred_Pres;
...
var natureza, descricao, tipo, ativo, cBenef, cCredPres, cst_icms, csosn, cst_ipi, enq_ipi, cst_pis, cst_cofins,
    aliq_icms, aliq_ipi, aliq_cofins, aliq_pis, tela: string;
    data: tdatetime;
begin
  natureza := EdtNatureza.Text;
  descricao := EdtDescricao.Text;
