...
var codigo, estado, pais, ativo, sigla, tela: string;
begin
 ...
 ShowMessage('Sigla não pode ser vazio!');
  ...
  CadEstadoModule.FDQuery.ParamByName('sigla').AsString := sigla;
...
begin
  ...
  CadEstadoModule.FDQuery.Close;
  CadEstadoModule.FDQuery.SQL.Text := 'select * from cadcidade where estado = :sigla';
  CadEstadoModule.FDQuery.ParamByName('sigla').AsString := sigla;
  CadEstadoModule.FDQuery.Open;
  ...
  CadEstadoModule.FDQuery.SQL.Clear;
  CadEstadoModule.FDQuery.Close;
  CadEstadoModule.FDQuery.SQL.Text := 'select * from cadcep where estado = :sigla';
  CadEstadoModule.FDQuery.ParamByName('sigla').AsString := sigla;
  CadEstadoModule.FDQuery.Open;
  ...
  CadEstadoModule.FDQuery.SQL.Clear;
  CadEstadoModule.FDQuery.Close;
  CadEstadoModule.FDQuery.SQL.Text := 'select * from cadentidade where estado = :sigla';
  CadEstadoModule.FDQuery.ParamByName('sigla').AsString := codigo;
  CadEstadoModule.FDQuery.Open;
...
begin
  ...
  EdtSigla.Text := CadEstadoModule.FDQuery1.FieldByName('sigla').AsString;
