...
begin
  EsCodigo := CadEstadoDM.ConsultarEstado.FieldByName('codigo').AsString;
  EsSigla := CadEstadoDM.ConsultarEstado.FieldByName('sigla').AsString;
  EsEstado := CadEstadoDM.ConsultarEstado.FieldByName('Estado').AsString;
  Close;
end;
