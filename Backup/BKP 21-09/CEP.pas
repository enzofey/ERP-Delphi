...
begin
 ...
 CadCidadeDM.ConsultarCidade.SQL.Clear;
 CadCidadeDM.ConsultarCidade.SQL.Text :=
 'select * from cadcidade where cidade = :cidade';
 CadCidadeDM.ConsultarCidade.ParamByName('cidade').AsString := cidade;
 CadCidadeDM.ConsultarCidade.Open;

 EdtCodigoCidade.Text := CadCidadeDM.ConsultarCidade.FieldByName('codigo').AsString;
end;
