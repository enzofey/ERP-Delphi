...
begin
  NatNatureza := CadNaturezaDataModule.ConsultarNatureza.FieldByName('natureza').AsString;
  NatDescricao := CadNaturezaDataModule.ConsultarNatureza.FieldByName('descricao').AsString;
  NatAtivo := CadNaturezaDataModule.ConsultarNatureza.FieldByName('ativo').AsString;
  NatTipo := CadNaturezaDataModule.ConsultarNatureza.FieldByName('tipo').AsString;
  NatCST_ICMS := CadNaturezaDataModule.ConsultarNatureza.FieldByName('CST_ICMS').AsString;
  NatCSOSN := CadNaturezaDataModule.ConsultarNatureza.FieldByName('CSOSN').AsString;
  NatCST_IPI := CadNaturezaDataModule.ConsultarNatureza.FieldByName('CST_IPI').AsString;
  NatENQ_IPI := CadNaturezaDataModule.ConsultarNatureza.FieldByName('ENQ_IPI').AsString;
  NatCST_PIS := CadNaturezaDataModule.ConsultarNatureza.FieldByName('CST_PIS').AsString;
  NatCST_COFINS := CadNaturezaDataModule.ConsultarNatureza.FieldByName('CST_COFINS').AsString;
  NatcBenef := CadNaturezaDataModule.ConsultarNatureza.FieldByName('cBenef').AsString;
  NatcCredPres := CadNaturezaDataModule.ConsultarNatureza.FieldByName('cCredPres').AsString;
  NatAliq_icms := CadNaturezaDataModule.ConsultarNatureza.FieldByName('aliq_icms').AsString;
  Nataliq_ipi := CadNaturezaDataModule.ConsultarNatureza.FieldByName('aliq_ipi').AsString;
  Nataliq_pis := CadNaturezaDataModule.ConsultarNatureza.FieldByName('aliq_pis').AsString;
  Nataliq_cofins := CadNaturezaDataModule.ConsultarNatureza.FieldByName('aliq_cofins').AsString;
  NatAliq_Cred_Pres := CadNaturezaDataModule.ConsultarNatureza.FieldByName('Aliq_Cred_Pres').AsString;
  Close;
end;
