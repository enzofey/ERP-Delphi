...
begin
  UCodigo := CadUsuarioDataModule.ConsultarUsuario.FieldByName('codigo').AsString;
  UUsuario := CadUsuarioDataModule.ConsultarUsuario.FieldByName('usuario').AsString;
  UAtivo := CadUsuarioDataModule.ConsultarUsuario.FieldByName('ativo').AsString;
  Close;
end;
