...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Data.DB, Vcl.StdCtrls, Vcl.Grids, CidadeDataModule,
...
type
  ...
  private
    ...
    CPais: string;
  public
    function SelecionarCidade: string;
...
function TConsultarCidade.SelecionarCidade: string;
begin
  CCidade := '';
  ShowModal;
  Result := CCidade;
...
begin
 begin
  CCodigo := CadCidadeDataModule.ConsultarCidade.FieldByName('codigo').AsString;
  CCidade := CadCidadeDataModule.ConsultarCidade.FieldByName('cidade').AsString;
  CPais := CadCidadeDataModule.ConsultarCidade.FieldByName('pais').AsString;
  CEstado := CadCidadeDataModule.ConsultarCidade.FieldByName('estado').AsString;
  CAtivo := CadCidadeDataModule.ConsultarCidade.FieldByName('ativo').AsString;
  Close;
end;
end;
end.
