...
begin
 ...
 EdtFaturaDUPL.Text := ReceberDataModule.ConsultarReceber.FieldByName('fatura').AsString;
 EdtentidadeDUPL.Text := ReceberDataModule.ConsultarReceber.FieldByName('entidade').AsString;
 EdtnumeroDUPL.Text := ReceberDataModule.ConsultarReceber.FieldByName('numero').AsString;
 DTPdtVenctoDUPL.Date := ReceberDataModule.ConsultarReceber.FieldByName('dtVencto').AsDateTime;
 DTPdtEmiDUPL.Date := ReceberDataModule.ConsultarReceber.FieldByName('dtEmissao').AsDateTime;
end;
