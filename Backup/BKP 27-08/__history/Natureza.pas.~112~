...
uses
  ...
  CSOSNDataModule, ConsultarCSOSNForm,
  CSTCOFINSDataModule, ConsultarCSTCOFINSForm,
  CSTICMSDataModule, ConsultarCSTICMSForm,
  CSTPISDataModule, ConsultarCSTPISForm,
  CSTIPIDataModule, ConsultarCSTIPIForm,
  ENQIPIDataModule, ConsultarEnqIPIForm;
...
begin
  ...
  CadNaturezaDataModule.SelectQuery.SQL.Clear;
  CadNaturezaDataModule.SelectQuery.Close;
  CadNaturezaDataModule.SelectQuery.SQL.Text :=
  'select * from cadnatureza where natureza = :natureza';
  CadNaturezaDataModule.SelectQuery.ParamByName('natureza').AsString := natureza;
  CadNaturezaDataModule.SelectQuery.Open;

  if not CadNaturezaDataModule.SelectQuery.IsEmpty then begin
  ShowMessage('Natureza já cadastrada!');
  end
  else begin

  CadNaturezaDataModule.InsertQuery.SQL.Clear;
  CadNaturezaDataModule.InsertQuery.SQL.Text :=
  ...
  CadNaturezaDataModule.InsertQuery.ParamByName('natureza').AsString := natureza;
  CadNaturezaDataModule.InsertQuery.ParamByName('descricao').AsString := descricao;
  CadNaturezaDataModule.InsertQuery.ParamByName('tipo').AsString := tipo;
  CadNaturezaDataModule.InsertQuery.ParamByName('ativo').AsString := ativo;
  CadNaturezaDataModule.InsertQuery.ParamByName('cBenef').AsString := cBenef;
  CadNaturezaDataModule.InsertQuery.ParamByName('cCredPres').AsString := cCredPres;
  CadNaturezaDataModule.InsertQuery.ParamByName('cst_icms').AsString := cst_icms;
  CadNaturezaDataModule.InsertQuery.ParamByName('csosn').AsString := csosn;
  CadNaturezaDataModule.InsertQuery.ParamByName('cst_ipi').AsString := cst_ipi;
  CadNaturezaDataModule.InsertQuery.ParamByName('enq_ipi').AsString := enq_ipi;
  CadNaturezaDataModule.InsertQuery.ParamByName('cst_pis').AsString := cst_pis;
  CadNaturezaDataModule.InsertQuery.ParamByName('cst_cofins').AsString := cst_cofins;
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_icms').AsFloat := StrToFloat(EdtAliqICMS.Text);
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_ipi').AsFloat := StrToFloat(EdtAliqIPI.Text);
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_pis').AsFloat := StrToFloat(EdtAliqPIS.Text);
  CadNaturezaDataModule.InsertQuery.ParamByName('aliq_cofins').AsFloat := StrToFloat(EdtAliqCOFINS.Text);
  CadNaturezaDataModule.InsertQuery.ParamByName('Aliq_Cred_Pres').AsFloat := StrToFloat(EdtAliq_Cred_Pres.Text);
  ...
  CadNaturezaDataModule.InsertQuery.ExecSQL;
...
begin
  ...
  CadNaturezaDataModule.UpdateQuery.SQL.Clear;
  CadNaturezaDataModule.UpdateQuery.SQL.Text :=
  ...
  CadNaturezaDataModule.UpdateQuery.ParamByName('natureza').AsString := natureza;
  CadNaturezaDataModule.UpdateQuery.ParamByName('descricao').AsString := descricao;
  CadNaturezaDataModule.UpdateQuery.ParamByName('tipo').AsString := tipo;
  CadNaturezaDataModule.UpdateQuery.ParamByName('ativo').AsString := ativo;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cBenef').AsString := cBenef;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cCredPres').AsString := cCredPres;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cst_icms').AsString := cst_icms;
  CadNaturezaDataModule.UpdateQuery.ParamByName('csosn').AsString := csosn;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cst_ipi').AsString := cst_ipi;
  CadNaturezaDataModule.UpdateQuery.ParamByName('enq_ipi').AsString := enq_ipi;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cst_pis').AsString := cst_pis;
  CadNaturezaDataModule.UpdateQuery.ParamByName('cst_cofins').AsString := cst_cofins;
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_icms').AsFloat := StrToFloat(EdtAliqICMS.Text);
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_ipi').AsFloat := StrToFloat(EdtAliqIPI.Text);
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_pis').AsFloat := StrToFloat(EdtAliqPIS.Text);
  CadNaturezaDataModule.UpdateQuery.ParamByName('aliq_cofins').AsFloat := StrToFloat(EdtAliqCOFINS.Text);
  CadNaturezaDataModule.UpdateQuery.ParamByName('Aliq_Cred_Pres').AsFloat := StrToFloat(EdtAliq_Cred_Pres.Text);
  ...
  ' no CST COFINS ' + CST_COFINS + ' alíquota de ICMS ' + aliq_icms + ' alíquota de IPI ' + aliq_ipi + ' alíquota de PIS ' + aliq_PIS +
  ' alíquota de COFINS ' + aliq_COFINS;
  LogModule.InserirLog.ParamByName('tela').AsString := 'CadNatureza';
  LogModule.InserirLog.ParamByName('emp_id').AsString := EmpresaLogada;
  LogModule.InserirLog.ParamByName('usuario').AsString := UsuarioLogado;
  LogModule.InserirLog.ParamByName('data').AsDateTime := Now;
  ...
  try
  LogModule.InserirLog.ExecSQL;
  CadNaturezaDataModule.UpdateQuery.ExecSQL;
  ShowMessage('Gravado com sucesso!');
  EdtNatureza.Enabled := False;
  EdtDescricao.Enabled := False;
  CBTipo.Enabled := False;
...
begin
  ...
  if CadNaturezaDataModule.SelectQuery.IsEmpty then begin
  ShowMessage('Natureza não encontrada!');
  end
  else begin

  CadNaturezaDataModule.DeleteQuery.SQL.Clear;
  CadNaturezaDataModule.DeleteQuery.SQL.Text :=
  'delete from cadnatureza where natureza = :natureza';
  CadNaturezaDataModule.DeleteQuery.ParamByName('natureza').AsString := natureza;
  ...
  try
  LogModule.InserirLog.ExecSQL;
  CadNaturezaDataModule.DeleteQuery.ExecSQL;
...
begin
 ...
 CadCSTPISDataModule.ConsultarCSTPIS.ParamByName('ativo').AsString := 'S';
