...
begin
  ECodigo := CadEntidadeDataModule.ConsultarEntidade.FieldByName('codigo').AsString;
  ENome := CadEntidadeDataModule.ConsultarEntidade.FieldByName('nome').AsString;
  EAtivo := CadEntidadeDataModule.ConsultarEntidade.FieldByName('ativo').AsString;
  ECPF := CadEntidadeDataModule.ConsultarEntidade.FieldByName('CPF').AsString;
  EDDD := CadEntidadeDataModule.ConsultarEntidade.FieldByName('DDD').AsString;
  ETelefone := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Telefone').AsString;
  ERua := CadEntidadeDataModule.ConsultarEntidade.FieldByName('rua').AsString;
  ENumero := CadEntidadeDataModule.ConsultarEntidade.FieldByName('numero').AsString;
  EEstado := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Estado').AsString;
  EBairro := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Bairro').AsString;
  ECidade := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Cidade').AsString;
  EPais := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Pais').AsString;
  EComplemento := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Complemento').AsString;
  ECEP := CadEntidadeDataModule.ConsultarEntidade.FieldByName('CEP').AsString;
  EEmail := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Email').AsString;
  EConsumidor_final := CadEntidadeDataModule.ConsultarEntidade.FieldByName('Consumidor_final').AsString;
  EIE := CadEntidadeDataModule.ConsultarEntidade.FieldByName('IE').AsString;
  EIndIE := CadEntidadeDataModule.ConsultarEntidade.FieldByName('IndIE').AsString;
  ModalResult := mrOk;
end;
end.
