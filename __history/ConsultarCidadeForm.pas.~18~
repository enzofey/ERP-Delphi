...
begin
 begin
  CCodigo := CadCidadeDM.ConsultarCidade.FieldByName('codigo').AsString;
  CCidade := CadCidadeDM.ConsultarCidade.FieldByName('cidade').AsString;
  CPais := CadCidadeDM.ConsultarCidade.FieldByName('pais').AsString;
  CEstado := CadCidadeDM.ConsultarCidade.FieldByName('estado').AsString;
  CAtivo := CadCidadeDM.ConsultarCidade.FieldByName('ativo').AsString;
  CCodigo_IBGE := CadCidadeDM.ConsultarCidade.FieldByName('Codigo_IBGE').AsString;
  Close;
end;
end;
end.
